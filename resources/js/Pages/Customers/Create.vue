                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="gender0" name="gender" v-model="form.gender" value="0" class=""></input>
                                                    <label for="gender0" class="leading-7 ml-3 text-sm text-gray-600">男性</label>
                                                    <input type="radio" id="gender1" name="gender" v-model="form.gender" value="1" class=""></input>
                                                    <label for="gender1" class="leading-7 ml-3 text-sm text-gray-600">女性</label>
                                                    <input type="radio" id="gender2" name="gender" v-model="form.gender" value="2" class=""></input>
                                                    <label for="gender2" class="leading-7 ml-3 text-sm text-gray-600">その他</label>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
